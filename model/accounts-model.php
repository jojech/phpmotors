...
//-------------------------------------------------------------------------
// This function will check if an email address exists in the clients table
//-------------------------------------------------------------------------
function duplicateEmailChecker($clientEmail) {
    $db = phpmotorsConnect();
    $sql = 'SELECT clientEmail FROM clients WHERE
